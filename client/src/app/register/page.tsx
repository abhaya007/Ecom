  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Top Area */}
        <div
          className="absolute top-16 left-16 animate-bounce opacity-30"
        ...
        <div
          className="absolute top-24 left-32 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-12 left-1/4 animate-bounce opacity-20"
        ...
        <div
          className="absolute top-20 right-24 animate-bounce opacity-30"
        ...
        <div
          className="absolute top-40 right-16 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-8 right-1/3 animate-bounce opacity-20"
          style={{ animationDelay: "3.2s", animationDuration: "3.5s" }}
        >
          <CreditCard className="w-7 h-7 text-blue-300" />
        </div>

        <div
          className="absolute top-36 right-1/4 animate-pulse opacity-25"
        ...
        {/* Middle Left Area */}
        <div
          className="absolute top-1/2 left-8 animate-bounce opacity-30"
        ...
        <div
          className="absolute top-1/3 left-20 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-2/5 left-12 animate-bounce opacity-20"
          style={{ animationDelay: "4.2s", animationDuration: "4.8s" }}
        >
          <Truck className="w-7 h-7 text-blue-300" />
        </div>

        <div
          className="absolute top-3/5 left-24 animate-pulse opacity-25"
        ...
        {/* Middle Right Area */}
        <div
          className="absolute top-1/2 right-8 animate-bounce opacity-30"
        ...
        <div
          className="absolute top-2/3 right-20 animate-pulse opacity-25"
          style={{ animationDelay: "1.8s" }}
        >
          <Package className="w-6 h-6 text-blue-400" />
        </div>
        ...
        <div
          className="absolute top-1/3 right-12 animate-bounce opacity-20"
        ...
        <div
          className="absolute top-3/5 right-28 animate-pulse opacity-25"
        ...
        {/* Bottom Area */}
        <div
          className="absolute bottom-24 left-24 animate-bounce opacity-30"
          style={{ animationDelay: "2.2s", animationDuration: "3.8s" }}
        >
          <Truck className="w-8 h-8 text-blue-400" />
        </div>

        <div
          className="absolute bottom-16 right-32 animate-pulse opacity-25"
        ...
        <div
          className="absolute bottom-32 left-1/3 animate-bounce opacity-20"
        ...
        <div
          className="absolute bottom-40 right-1/4 animate-pulse opacity-25"
        ...
        <div
          className="absolute bottom-12 left-1/4 animate-bounce opacity-20"
        ...
        <div
          className="absolute bottom-28 right-1/3 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-1/4 left-1/3 animate-bounce opacity-20"
        ...
        <div
          className="absolute top-3/4 right-1/3 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-1/5 left-2/3 animate-bounce opacity-20"
          style={{ animationDelay: "3.5s", animationDuration: "4.3s" }}
        >
          <Gift className="w-5 h-5 text-blue-300" />
        </div>

        <div
          className="absolute top-4/5 left-1/2 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-2/5 right-2/3 animate-bounce opacity-20"
          style={{ animationDelay: "5.2s", animationDuration: "3.7s" }}
        >
          <CreditCard className="w-5 h-5 text-blue-300" />
        </div>

        <div
          className="absolute top-3/5 left-3/5 animate-pulse opacity-25"
        ...
        <div
          className="absolute top-1/6 right-1/5 animate-bounce opacity-15"
          style={{ animationDelay: "6s", animationDuration: "4.5s" }}
        >
          <Package className="w-4 h-4 text-blue-200" />
        </div>

        <div
          className="absolute top-5/6 left-1/5 animate-pulse opacity-20"
          style={{ animationDelay: "2.5s" }}
        >
        ...
        <div
          className="absolute top-1/8 left-3/4 animate-bounce opacity-15"
          style={{ animationDelay: "7s", animationDuration: "3.3s" }}
        >
          <Gift className="w-4 h-4 text-blue-200" />
        </div>

        <div
          className="absolute top-7/8 right-3/4 animate-pulse opacity-20"
      ...
      <div>
          ...
          <div>
            <button className=" bg-transparent ">
              <img
                src="/logo.png"
                alt="Kharid Logo"
                className="h-28 mx-auto  bg-transparent"
              />
              <span
        ...
        <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-5">
            <CardTitle className="text-2xl font-bold text-center text-[#2a4458]">
              Create Account
            </CardTitle>
          ...
          <CardContent>
              ...
              {({ errors, touched, values, setFieldValue }) => (
                <Form className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label
                      htmlFor="username"
                      className="text-sm font-bold text-[#2a4458]"
                    >
                      Username
                    </Label>
                  ...
                  <p className="text-xs text-gray-600 text-center mt-4">
                    ...
                    <Link
                      href="/terms"
                      className="text-[#f8732c] hover:text-[#2a4458] underline"
                    >
                      Terms of Service
                    </Link>{" "}
                    and{" "}
            ...
            <div className="text-center mt-6 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  href="/login"
                  className="text-[#f8732c] hover:text-[#2a4458] font-semibold underline"
                >
                  Sign-In
                </Link>
              </p>
